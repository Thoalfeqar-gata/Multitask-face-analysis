...
class SwinTransformer(nn.Module):
    ...
    Args:
        ...
        in_chans (int): Number of input image channels. Default: 3
        feature_embedding_dim (int): The desired number of features to be output. Default 512.
    ...
    def __init__(self, img_size=112, patch_size=2, in_chans=3, feature_embedding_dim=1000,
    ...
    def flops(self):
        ...
        flops += self.num_features * self.feature_embedding_dim
        return flops
