...
from multitask.framework1.subnets import FaceRecognitionEmbeddingSubnet, EmotionRecognitionSubnet, AgeEstimationSubnet, GenderRecognitionSubnet, RaceRecognitionSubnet, AttributeRecognitionSubnet, PoseEstimationSubnet
...
class MultiTaskFaceAnalysisModel(nn.Module):
    def __init__(self, num_classes, **kwargs):
        ...
        # Subnet args
        self.multiscale_fusion_type = kwargs.get('multiscale_fusion_type')
        ...
        # Emotion Recognition
        self.emotion_recognition_subnet = EmotionRecognitionSubnet(multiscale_fusion_type=self.multiscale_fusion_type)

        # Age Estimation
        self.age_estimation_subnet = AgeEstimationSubnet(multiscale_fusion_type=self.multiscale_fusion_type)

        # Gender Recognition
        self.gender_recognition_subnet = GenderRecognitionSubnet(multiscale_fusion_type=self.multiscale_fusion_type)
